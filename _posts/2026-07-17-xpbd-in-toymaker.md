...
states are _displayed_ to the user 10s of times each second too, in the form of rapidly changing images, to give the
...
already provides a representation for the shape, position, and orientation of the object, so our next task is to make a
struct for the object's _other_ physical properties.
